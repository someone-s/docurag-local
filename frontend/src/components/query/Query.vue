...
const queryState = ref(new QueryState(
...
<template>
  <ResizablePanelGroup direction="horizontal">
    <ResizablePanel>
      <ChatColumn ref="chat" class="h-full" :key="updateKey" :allow-edit="!queryState.processing" :entries="queryState.entries" :send-query="query => queryState.sendQuery(query)"
